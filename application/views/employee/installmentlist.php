 ...
 <div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="main-card mb-3 card">
            <div class="card-header header_decider">Installment List</div>
            <div class="card-body">
                <form id="formList">
                    <div class="row">
              ...
              <!-- <a href="<?//= base_url('employeelevel/empYearListAdd') ?>" class="btn btn-primary mb-3"><i class="fa fa-fw"></i> Add Year</a>  -->
                <div class="table-responsive">
                    <table class="table table-bordered table-hover dataTable no-footer dtr-inline installmentlists" id="installmentlist">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Customer Name</th>
