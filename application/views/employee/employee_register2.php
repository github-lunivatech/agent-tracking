...
<!-- <input type="hidden" name="eid1" class="nextornotforpersonaldetails" value="0">
<input type="hidden" name="eid2" class="nextornotforaddressdetails" value="0">
<input type="hidden" name="eid1" class="nextornotfornomineedetails" value="0"> -->
...
<form id="address-details" method="POST" action="<?php echo base_url('employee/InsertUpdatePersonalEmployeeAddressDetails')?>">      
...
<input type="hidden" name="eid" class="hidden_eid">
                        <div class="form-row form-inline">
                            ...
                            <div class="form-row form-inline">
                               <?php  if(isset($_GET['q'])){?>
                                ...
                                <input type="hidden" name="districtId0" id="districtId0" value="<?php if($DistrictId0 != '') echo $DistrictId0?>" readonly>
                                 ...
                                 <input type="hidden" name="districtId1" id="districtId1" value="<?php if($DistrictId1 != '') echo $DistrictId1 ?>" readonly>
                               ...
                               <input type="hidden" name="aid0" id="aid" value=""  readonly>

                                <input type="hidden" name="aid1" id="ef" value="">
                            ...
                            <div class="form-row form-inline">
                                ...
                                <div class="col-md-12 form-group mb-3">
                                    <label for="qualification" class="col-md-4 col-sm-4 col-xs-12">State <span class="required">*</span> </label>
                                    <select id="StateId1" name="StateId" class="form-control col-md-7 col-sm-7 col-xs-12"  onchange="changestate1()"> 
                                   <option value="">Select State</option>
                                   <?php //foreach ($states->GetStates as $state) {
                                         // printf('<option value="%d">%s</option>',$state->Id,$state->Name);
                                    //} ?>
...
<div class="tab-pane fade hide" id="nominee-details-tab" role="tabpanel" aria-labelledby="nominee-details-tab-lb">
  <form id="form-3" method="GET" action="<?php echo base_url('employee/insertUpdateReferenceCon')?>">
<div class="form-row form-inline">
